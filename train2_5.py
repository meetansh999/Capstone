...
class OilSpillDataset(Dataset):
    def __init__(self, image_dir, mask_dir, augment=False):
        ...
        self.img_transforms = transforms.Compose([
            ...
            transforms.RandomResizedCrop(size=224, scale=(0.65, 1.0)),  # Random crop then resize back to 224x224
...
class HybridLoss(nn.Module):
    def __init__(self, alpha=0.8, gamma=2.5):
        ...
        self.ce_loss = nn.CrossEntropyLoss(weight=torch.tensor([0.5, 2.0, 1.6, 2.8, 1.0], device=device))
...
if __name__ == "__main__":
    ...
    # save model
    torch.save(model.state_dict(), "train2_5.pth")
