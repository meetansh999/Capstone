...
import cv2
import numpy as np
from model_res34 import ResNet34_UNet  # ✅ Updated to import ResNet34-based U-Net
...
class OilSpillDataset(Dataset):
    ...
    def _convert_mask(self, mask):
        ...
        mask = cv2.cvtColor(mask, cv2.COLOR_BGR2RGB)  # ✅ Ensure correct color space
...
# ✅ Loss Functions
loss_fn = nn.CrossEntropyLoss(weight=torch.tensor([0.4, 2.5, 1.6, 1.9, 1.0], device=device))  # Class weights
...
if __name__ == "__main__":
    ...
    # ✅ Load ResNet34 + U-Net
    model = ResNet34_UNet(num_classes=5, dropout_p=0.3).to(device)  # ✅ Updated Model
    ...
    # ✅ Save Model
    torch.save(model.state_dict(), "resnet34_unet.pth")
