...
from model_res34 import ResNet34_UNet  # ✅ Import the new model
...
model_path = "resnet34_unet.pth"  # ✅ Update to the latest trained ResNet-34 model
output_dir = "predictions_resnet34"
...
# Load Model
model = ResNet34_UNet(num_classes=5).to(device)  # ✅ Use ResNet-34 U-Net model
...
class OilSpillTestDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image = np.expand_dims(image, axis=0)  # Convert to (1, H, W) for grayscale
