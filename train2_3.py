...
class OilSpillDataset(Dataset):
    def __init__(self, image_dir, mask_dir, augment=False):
        ...
        self.img_transforms = transforms.Compose([
            ...
            transforms.RandomResizedCrop(size=224, scale=(0.5, 1.0)),  # Random crop then resize back to 224x224
...
class HybridLoss(nn.Module):
    def __init__(self, alpha=0.8, gamma=2.5):
        ...
        self.ce_loss = nn.CrossEntropyLoss(weight=torch.tensor([0.5, 2.6, 1.6, 5.2, 1.3], device=device))
    ...
    def focal_loss(self, preds, targets, gamma=2):
    ...
    def forward(self, preds, targets):
        ...
        return ce + 0.4 * dice + 0.6 * focal  # ✅ Weighted combination
...
if __name__ == "__main__":
    ...
    for epoch in range(num_epochs):
        ...
        if avg_val_loss < best_val_loss:
            ...
            torch.save(model.state_dict(), "best_modelnow.pth")  # ✅ Save the best model
        else:
