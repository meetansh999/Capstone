...
from model_3 import UNetEfficientNet  
...
class HybridLoss(nn.Module):
    ...
    def dice_loss(self, preds, targets):
        ...
        return 1 - dice.mean()  # ✅ Ensuring scalar output

    def focal_loss(self, preds, targets, gamma=2.0):
        ce_loss = nn.CrossEntropyLoss(reduction="mean")(preds, targets)  # ✅ Ensuring scalar output
...
if __name__ == "__main__":
    ...
    model = UNetEfficientNet(num_classes=5, dropout_p=0.4).to(device)
    ...
    for epoch in range(num_epochs):
        ...
        for images, masks in train_loader:
            ...
            # # ✅ Print GPU memory usage after forward pass
    ...
    torch.save(model.state_dict(), "efficientnet_oilspill.pth")
